            ...
            {deleteFilter == "Active"
              ? hasTimeElapsedWeapon == false && (
                  <span className="statusColorCorrectWeapon">
                    Grenade has been deleted
                  </span>
                )
              : deleteFilter == "Deleted"
              ? hasTimeElapsedWeapon == false && (
                  <span className="statusColorCorrectWeapon">
                    Grenade has been restored
                  </span>
                )
...
export default GrenadesWeapons;
