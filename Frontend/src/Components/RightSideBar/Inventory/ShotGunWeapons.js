            ...
            {deleteFilter == "Active"
              ? hasTimeElapsedWeapon == false && (
                  <span className="statusColorCorrectWeapon">
                    Shotgun has been deleted
                  </span>
                )
              : deleteFilter == "Deleted"
              ? hasTimeElapsedWeapon == false && (
                  <span className="statusColorCorrectWeapon">
                    Shotgun has been restored
                  </span>
                )
