...
function AssaultsWeapons() {
  ...
  const setDeleteAll = (deleteFilter) => {
    console.log("deleteFilter77:", deleteFilter);
  ...
  useEffect(() => {
    ApiService.getTotalWeapons()
      .then(function (response) {
        console.log("Checkrecent:", response.data);
        var setWeaponFilter = response.data?.filter(function (el) {
          return el.type == "Machinegun";
        });
        console.log("newArray7755:", setWeaponFilter);
        ...
        if (response) {
          ApiService.getTotalWeapons()
            .then(function (response) {
              ...
              console.log("setWeaponFilter55:", setWeaponFilter);
              setState(setWeaponFilter);
              setTimeout(() => {
...
export default AssaultsWeapons;
