            ...
            <div className="row">
              <div className="col-md-7">
                <div className="weapn">
                  ...
                  <model-viewer
                    ...
                    //src="./img/gun_incineratorthermoelectricity_rifle/scene.gltf"
                    ar
              ...
              <div className="col-md-5">
                <div className="gun_head">
                  ...
                  <h5>Automatic Gun</h5>
                  <p>
                    50 Caliber Auto Gun.Heavy barrel automatic with recoil air
                    cooled gun with adjustable gears.Can be used in worst
                    weather and easy to handel its grip is very well to grab the
                    gun easily.50 Caliber Auto Gun.Heavy barrel automatic with
                    recoil air cooled gun with adjustable gears.Can be used in
                    worst weather and easy to handel its grip is very well to
                    grab the gun easily.
                  </p>
                </div>
